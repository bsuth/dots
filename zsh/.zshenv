...
function erdedev() {
  ...
  alias erde="lua $ERDE_ROOT/erde/cli.lua"
  alias erdejit="luajit $ERDE_ROOT/erde/cli.lua"
  alias erde5.1="lua5.1 $ERDE_ROOT/erde/cli.lua"
  alias erde5.2="lua5.2 $ERDE_ROOT/erde/cli.lua"
